...
st.latex(r"SQ = 1 - \eta\cdot\frac{4\sqrt{P/P_{th}}}{(1 + \sqrt{P/P_{th}})^2 + \Bigg(\frac{f}{f_{HWHM}}\Bigg)^2}")
st.latex(r"ASQ = 1 + \eta\cdot\frac{4\sqrt{P/P_{th}}}{(1 - \sqrt{P/P_{th}})^2 + \Bigg(\frac{f}{f_{HWHM}}\Bigg)^2}")
