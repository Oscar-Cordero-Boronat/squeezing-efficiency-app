...
st.latex(r"SQ = 1 - \eta\cdot\frac{4\sqrt{P/P_{th}}}{\Big(1 + \sqrt{\frac{P}{P_{th}}}\Big)^2 + \Big(\frac{f}{f_{HWHM}}\Bigg)^2}")
st.latex(r"ASQ = 1 + \eta\cdot\frac{4\sqrt{P/P_{th}}}{(1 - \sqrt{P/P_{th}})^2 + \Big(\frac{f}{f_{HWHM}}\Bigg)^2}")
